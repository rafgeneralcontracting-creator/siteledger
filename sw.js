const CACHE='siteledger-v17';
const SHELL=['./','./index.html','./styles.css?v=12','./drawings.css?v=4','./drawing-workspace.css?v=1','./app.js?v=12','./drawings.js?v=4','./drawing-workspace.js?v=1','./manifest.webmanifest','./icon.svg'];
